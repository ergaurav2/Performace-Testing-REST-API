...
<body style="margin-left: auto;margin-right: auto; width: 70%;height:600px;border-style: solid;border-width: 1px;">	
	...
	<div style="padding-top: 1cm">	
		<form id="inputform" action="generate" method="post">
			...
			<table style="float:left;padding-left:200px;">
				  <tr>
				    <td>Base Url :</td>
				    <td><input type="text" required name="baseUrl" placeholder="Enter URL" class=box></td> 
				  </tr>

				  <tr>
				    <td>Poll Frequency :</td>
				    <td><input type="number" required name="pollFrequency" class=box></td> 
				  </tr>

					<tr>
					    <td>Number of Users :</td>
					    <td><input type="number" required name="noUsers" class=box></td> 
					  </tr>

					<tr>
					    <td>Path :</td>
					    <td><input type="text" required name="path" class=box></td> 
					  </tr>
